...
public class featureSelectionNewMethod {
	...
	public featureSelectionNewMethod(Instances dataset,int seed,int attr_num,int neight) throws Exception{
	...
	private void setAverageRankingOfAttribute(Instances dataProcess,int att_no,int rank,int index){
		...
		double priority = 0;
		if(index == 0){
			priority = (num_att - rank)*3; //3  //3
		}else if(index == 1){
			priority = (num_att - rank)*2; //4  //2
		}else if(index == 2){
			priority = (num_att - rank)*6; //2  //5
		}else if(index == 3){
			priority = (num_att - rank)*4; //6  //4
		}else if(index == 4){
			priority = (num_att - rank);
		}
		
		//--> Lung Cancer
		/*if(index == 0){
			priority = (num_att - rank)*3; 
		}else if(index == 1){
			priority = (num_att - rank)*2; 
		}else if(index == 2){
			priority = (num_att - rank)*4; 
		}else if(index == 3){
			priority = (num_att - rank)*6; 
		}else if(index == 4){
			priority = (num_att - rank);
		}*/
		//end added
